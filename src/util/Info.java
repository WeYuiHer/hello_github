...
public class Info {
	...
	public static String tform(HashMap map)
	{
    	...
    	jscode+="{\n";
    	 ...
    	 while(it.hasNext())
    	 {
    	  ...
    	  jscode+="{\n";
    	  jscode+="document.getElementById(\"txt\").src=\"/schoolzjssys/upfile/"+map.get("filename")+"\";\n";
    	  jscode+="}\n";
    	 }
    	 jscode+="}\n";
	...
	public static String getAutoNo(){
	 ...
	 /**
		...
		{
			String jscode = "";
			jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/schoolzjssys/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
			jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
			jscode+="<script type=\"text/javascript\"  src=\"/schoolzjssys/js/popup.js\"></script>";
			return jscode;
		}
